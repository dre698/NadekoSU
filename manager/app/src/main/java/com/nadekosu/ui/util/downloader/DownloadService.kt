package com.nadekosu.ui.util.downloader
...
import com.nadekosu.data.update.ZipRangeArchive
...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD = "com.nadekosu.action.DOWNLOAD"
        const val ACTION_DOWNLOAD_MANAGER_APK = "com.nadekosu.action.DOWNLOAD_MANAGER_APK"
        const val ACTION_CANCEL = "com.nadekosu.action.CANCEL_DOWNLOAD"
        const val ACTION_DISMISS_DOWNLOAD = "com.nadekosu.action.DISMISS_DOWNLOAD"
        const val ACTION_INSTALL_MODULE = "com.nadekosu.action.INSTALL_MODULE"
