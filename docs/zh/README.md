...
[![最新发行](https://img.shields.io/github/v/release/dre698/NadekoSU?label=Release&logo=github)](https://github.com/dre698/NadekoSU/releases/latest)
[![最新 CI 构建（nightly.link）](https://img.shields.io/badge/nightly.link-%E6%9C%80%E6%96%B0%20CI%20%E6%9E%84%E5%BB%BA-800080)](https://nightly.link/dre698/NadekoSU/workflows/build-manager/main)
[![频道](https://img.shields.io/badge/Follow-Telegram-blue.svg?logo=telegram)](https://t.me/dre698trashes)
...
[![其他部分 License：GPL v3](https://img.shields.io/github/license/dre698/NadekoSU?logo=gnu)](/LICENSE)
...
6. 多管理器支持，默认支持使用 [官方KernelSU](https://github.com/tiann/KernelSU)/[RKSU](https://github.com/rsuntk/KernelSU)/[MKSU](https://github.com/5ec1cff/KernelSU)/[SukiSU](https://github.com/SukiSU-Ultra/SukiSU-Ultra) 作为管理器与 NadekoSU 内核共同工作

## 兼容状态

- NadekoSU 官方支持 GKI 2.0 的设备（内核版本 5.10 以上）。
...
请参考[文档](https://NadekoSU.github.io)

## 参与翻译

要将 NadekoSU 翻译成您的语言，或完善现有的翻译，请使用 [Weblate](https://hosted.weblate.org/engage/nadekosu/).
...
在 Weblate 上对 NadekoSU 的翻译做出贡献:

https://hosted.weblate.org/engage/nadekosu/

[![翻译状态](https://hosted.weblate.org/widget/nadekosu/multi-auto.svg)](https://hosted.weblate.org/engage/nadekosu/)
