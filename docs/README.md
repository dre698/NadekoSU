# NadekoSU
<img align='right' src='NadekoSU_blue.svg' width='220px' alt="NadekoSU Icon">
...
[![Latest release](https://img.shields.io/github/v/release/dre698/NadekoSU?label=Release&logo=github)](https://github.com/dre698/NadekoSU/releases/latest)
[![Latest CI build (nightly.link)](https://img.shields.io/badge/nightly.link-Latest%20CI%20Build-800080)](https://nightly.link/dre698/NadekoSU/workflows/build-manager/main)
[![Channel](https://img.shields.io/badge/Follow-Telegram-blue.svg?logo=telegram)](https://t.me/dre698trashes)
...
[![Other part License：GPL v3](https://img.shields.io/github/license/dre698/NadekoSU?logo=gnu)](/LICENSE)
...
6. Multi manager support, for default [Official KernelSU](https://github.com/tiann/KernelSU)/[RKSU](https://github.com/rsuntk/KernelSU)/[MKSU](https://github.com/5ec1cff/KernelSU)/[SukiSU](https://github.com/SukiSU-Ultra/SukiSU-Ultra) is supported work as manager with NadekoSU's kernel

## Compatibility Status

- NadekoSU officially supports Android GKI 2.0 devices (kernel 5.10+).
...
See the [documentation](https://NadekoSU.github.io).

## Translation

If you need to submit a translation for the manager, please go to [Weblate](https://hosted.weblate.org/engage/nadekosu/).
...
Help translate NadekoSU on Weblate:

https://hosted.weblate.org/engage/nadekosu/

[![Localization Status](https://hosted.weblate.org/widget/nadekosu/multi-auto.svg)](https://hosted.weblate.org/engage/nadekosu/)
