...
For languages other than English and Chinese Simplified, please don't create pull requests for translations; instead, use [Weblate](https://hosted.weblate.org/engage/NadekoSU).

## Reporting bugs

Before reporting a bug, please first read the [document](https://dre698.github.io/NadekoSU)
...
When you [Open an issue](https://github.com/dre698/NadekoSU/issues), you **must**:
...
[Open an issue](https://github.com/dre698/NadekoSU/issues) describing the feature you want and your reason for it.
...
```
>- then Joe Smith would upload the patch for NadekoSU as
```
