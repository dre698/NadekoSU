...
The application code is rooted at `com.nadekosu`.
...
Repository implementations belong under `com.nadekosu.data` and its subpackages. Keep
...
`com.nadekosu.ui.component.Dialog#rememberCustomDialog`,
if you need confirmDialog, use `com.nadekosu.ui.component.Dialog#rememberConfirmDialog`,
if you need loadingDialog, use `com.nadekosu.ui.component.Dialog#rememberLoadingDialog`
...
```text
com.nadekosu.ui.component.settings
```
...
```text
com.nadekosu.ui.component.settings.material3internal.AnimatedShape.kt
```
...
* Reusable components are under `com.nadekosu.ui.component`.
* Settings screens use `com.nadekosu.ui.component.settings` components.
