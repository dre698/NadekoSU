package com.nadekosu.data.update
...
object ManagerUpdateRepository {
    ...
    private const val REPOSITORY = "dre698/NadekoSU"
    ...
    private const val CI_MANAGER_VERSION_CODE_OFFSET = 33300
    ...
    private val managerApkPattern = Regex(
        "^NadekoSU_(.+)_(\\d+)-(arm64-v8a|armeabi-v7a|x86_64|universal)-release\\.apk$"
    )
    ...
    fun checkBetaUpdate(
        ...
        return ManagerUpdateInfo(
            ...
            abi = preferredAbi,
            fileName = "NadekoSU_${headSha.take(SHORT_SHA_LENGTH)}_" +
